...
void main() {
  ...
  group('base32', () {
    ...
    group('Crockford', () {
      ...
      test('decode with i I l L  o O symbols', () {
        expect(
          base32CrockfordDecode(encodedWithReplaceSymbols),
  ...
  group('base58', () {
    ...
    group('Bitcoin', () {
        ...
        () {
          test('encode', () {
            for (final set in testData) {
              expect(
                base58BitcoinEncode(Uint8List.fromList(base16.decode(set[0]))),
                equals(set[1]),
              );
            }
          });
          test('decode', () {
            for (final set in testData) {
              expect(
                base16.encode(base58BitcoinDecode(set[1])),
      ...
      test('encode with zero', () {
        expect(
          base58BitcoinEncode(Uint8List.fromList(dataWithZero)),
    ...
    group('Flickr', () {
      ...
      test('encode with zero', () {
        expect(
          base58FlickrEncode(Uint8List.fromList(dataWithZero)),
          equals(encodedDataWithZero),
        );
      });
      test('decode with zero', () {
    ...
    group('Ripple', () {
      ...
      test('encode with zero', () {
        expect(
          base58RippleEncode(Uint8List.fromList(dataWithZero)),
          equals(encodedDataWithZero),
        );
      });
      test('decode with zero', () {
  ...
  group('base85', () {
    ...
    group('IPv6', () {
      ...
      test('decode', () {
        expect(base85IPv6Decode(encoded), base16.decode(address));
      });
    });
    group('base58Check', () {
